...
def generate_seq_c_file():
    ...
    for task in task_set:
        for element in task.sequences:
            ...
            sequencesC.write("   int stop = RBS_Wait(seq_data);\n")
            
            sequencesC.write("   if(stop == 1)\n")
            
            sequencesC.write("   {\n")
            
            sequencesC.write("      return 0;\n")
...
def generate_seq_h_file():
    ...
    sequencesH.write("#include <stdint.h>\n")
    sequencesH.write("#include \"../rbs_lib_kernel/rbs_lib_kernel.h\" \n")
...
def generate_workload_h_file():
    ...
    workloadH.write("#include \"../otw/otw.h\"\n\n")
